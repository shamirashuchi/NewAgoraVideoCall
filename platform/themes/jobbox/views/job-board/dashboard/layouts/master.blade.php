...
<body @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl" @endif id="bgDesign">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var bgDesignValue = document.getElementById('bgDesign');
            if (bgDesignValue) {
                if (window.location.href == window.location.origin + "/account/home") {
                    bgDesign.style.backgroundColor = '#05264E';
                } else if (window.location.href == window.location.origin + "/account/packages") {
                    bgDesign.style.backgroundColor = '#EFF6F9';
                } else if (window.location.href == window.location.origin + "/account/settings") {
                    bgDesign.style.backgroundColor = '#05264E';
                }
            }
        });
