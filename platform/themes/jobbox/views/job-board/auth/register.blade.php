...
<section class="pt-70 login-register">
        ...
        <div class="row login-register-cover align-items-center">
            ...
            <div class="col-lg-6 col-md-8 col-sm-12 mx-auto">
                <div class="text-center mb-4">
                    <h4 class="mt-10 mb-5 text-brand-1">{{ __('Create account of job seeker') }}</h4>
                </div>
                ...
                <form class="login-register text-start mt-20" action="{{ route('public.account.register') }}"
                    method="post">
                    @csrf
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="form-group">
                            <button class="btn btn-brand-1 hover-up w-100" type="submit"
                                style="background-color: #F9A620; margin-top: 20px;">
                                {{ __('Create Account') }}
                            </button>
                        </div>

                        <div class="text-center">
                            <b>{{ __('Already have an account?') }}</b>
    ...
    <script>
        ...
        document.getElementById("jobSeeker").checked = true;
