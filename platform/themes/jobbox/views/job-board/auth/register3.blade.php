        ...
        <div class="row login-register-cover align-items-center">
            ...
            <div class="col-lg-6 col-md-8 col-sm-12 mx-auto">
                <div class="text-center mb-4">
                    <h4 class="mt-10 mb-5 text-brand-1">{{ __('Create account of consultant') }}</h4>
                </div>
                ...
                <form class="login-register text-start mt-20" action="{{ route('public.account.register3') }}"
                    method="post">
                    @csrf
                    <div class="row">
                    ...
                    <div class="form-group">
                        <button class="btn btn-brand-1 hover-up w-100" type="submit" style="background-color: rgba(5, 38, 78, 1)">
                            {{ __('Create Account') }}
                        </button>
                    </div>
