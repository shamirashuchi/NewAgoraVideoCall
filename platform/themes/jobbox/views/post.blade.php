...
<main class="main">
    <section class="section-box">
        @if ($post->getMetaData('cover_image', true))
            <img src="{{ RvMedia::getImageUrl($post->getMetaData('cover_image', true), null, false, RvMedia::getDefaultImage()) }}" alt="{{ $post->title }}">
        @else
            <img src="{{ Theme::asset()->url('imgs/page/blog/img-single.png') }}" alt="{{ $post->title }}">
        @endif
    </section>
    <section class="section-box">
