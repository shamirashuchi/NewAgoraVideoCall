...
<div class="form-group">
    <label class="control-label">{{ __('High light title text') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Image job 1') }}</label>
    {!! Form::mediaImage('image_job_1', Arr::get($attributes, 'image_job_1')) !!}
</div>

<div class="form-group">
    <label class="control-label">{{ __('Image job 2') }}</label>
