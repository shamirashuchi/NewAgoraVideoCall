                        ...
                        <form method="POST" action="{{ route('public.account.password.email') }}">
                            ...
                            <div class="form-group">
                                <input id="email" type="email"
                                       ...
                                       name="email" value="{{ old('email') }}" required placeholder="{{ trans('plugins/job-board::dashboard.email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group mb-0">
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('public.account.login') }}"
                                           class="btn btn-link">{{ trans('plugins/job-board::dashboard.back-to-login') }}</a>
                                    </div>
                            </div>
                        </form>
                    </div>
