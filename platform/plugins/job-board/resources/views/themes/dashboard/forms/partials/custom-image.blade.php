<div class="image-box">
    ...
    <div class="preview-image-wrapper">
        <img src="{{ RvMedia::getImageUrl($value, 'thumb', false, $attributes['placeholder'] ?? RvMedia::getDefaultImage()) }}" data-default-image="{{ $attributes['placeholder'] ?? RvMedia::getDefaultImage() }}" alt="{{ trans('core/base::base.preview_image') }}" class="preview_image" width="150">
