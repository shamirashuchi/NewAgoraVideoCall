...
use Botble\JobBoard\Repositories\Eloquent\ConsultantPackageRepository;
...
use Botble\JobBoard\Repositories\Caches\ConsultantPackageCacheDecorator;
...
class JobBoardServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(ConsultantPackageInterface::class, function () {
            return new ConsultantPackageCacheDecorator(
                new ConsultantPackageRepository(new ConsultantPackage())
            );
        });
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    ...
                    'priority' => 16,
                    'parent_id' => 'cms-plugins-job-board-main',
                    'name' => 'plugins/job-board::consultant-package.name',
                    'icon' => 'fas fa-money-check-alt',
                    'url' => route('public.account.consultant-packages.index'),
                    'permissions' => ['public.account.consultant-packages.index'],
                ])
                ->registerItem([
                ...
                ->registerItem([
                    'id' => 'cms-plugins-job-board-import-jobs',
                    'priority' => 14,
                    'parent_id' => 'cms-plugins-job-board-main',
                    'name' => 'plugins/job-board::bulk-import.name',
                    'icon' => 'fas fa-file-import',
                    'url' => route('bulk-import.index'),
                    'permissions' => ['job-board.bulk-import.index'],
                ])
                ->registerItem([
                    'id' => 'cms-plugins-job-board-export-jobs',
                    'priority' => 15,
                    'parent_id' => 'cms-plugins-job-board-main',
                    'name' => 'plugins/job-board::export.jobs.name',
                    'icon' => 'fas fa-file-export',
                    'url' => route('export-jobs.index'),
                    'permissions' => ['export-jobs.index'],
                ]);
