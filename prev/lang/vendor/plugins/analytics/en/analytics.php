...
return [
    ...
    'visits' => 'visits',
    'views' => 'views',
    'view_id_not_specified' => 'You must provide a valid view id. Contact here here: <a href="https://www.devres.tech/" target="_blank">https://www.devres.tech/</a>',
    'credential_is_not_valid' => 'Analytics credentials is not valid. Contact here here: <a href="https://www.devres.tech/" target="_blank">https://www.devres.tech/</a>',
    'start_date_can_not_before_end_date' => 'Start date :start_date cannot be after end date :end_date',
    'wrong_configuration' => 'To view analytics you\'ll need to get a google analytics client id and add it to your settings. <br /> You also need JSON credential data. <br /> Contact here here: <a href="https://www.devres.tech/" target="_blank">https://www.devres.tech/</a>',
    'settings' => [
