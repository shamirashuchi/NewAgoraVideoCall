                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-6 col-12">
                        ...
                        <div class="box-form-newsletter mt-40">
                            <form class="form-newsletter subscribe-form newsletter-form" action="{{ route('public.newsletter.subscribe') }}" method="post">
                                @csrf
                                <input class="input-newsletter" type="text" value="{{ old('email') }}" name="email" placeholder="{{ __('Enter your email here') }}">
