        ...
        <div class="container">
            <div class="banner-hero banner-image-single">
                @if ($account->getMetaData('cover_image', true))
                    <img src="{{ RvMedia::getImageUrl($account->getMetaData('cover_image', true), null, false, RvMedia::getDefaultImage()) }}" alt="{{ $account->name }}">
                @else
                    <img src="{{ Theme::asset()->url('imgs/page/candidates/img.png') }}" alt="{{ $account->name }}">
                @endif
            </div>
