                ...
                <div class="display-flex2">
                    ...
                    <div class="box-border">
                        ...
                        <div class="dropdown dropdown-sort">
                            ...
                            <button class="btn dropdown-toggle" id="dropdownSort2" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static">
                                <span>{{ ucfirst(BaseHelper::stringify(request()->query('sort_by', $orderByParams[0]))) }}</span>
                                <i class="fi-rr-angle-small-down"></i>
                            </button>
                            <ul class="dropdown-menu js-dropdown-clickable dropdown-menu-light" aria-labelledby="dropdownSort2">
                                @foreach($orderByParams as $orderByParam)
                                    <li>
                                        <a
                                            @class(['dropdown-item sort-by', 'active' => BaseHelper::stringify(request()->query('sort_by', $orderByParams[0])) === $orderByParam])
                                            data-sort-by="{{ $orderByParam }}"
                                            href="#"
                                        >
                                            {{ ucfirst($orderByParam) }}
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                    ...
                    <div class="box-view-type">
                        @switch(BaseHelper::stringify(request()->query('layout')))
                            ...
                            @default
                                <a class="view-type layout-company" href="#" data-layout="list">
                                    <img src="{{ Theme::asset()->url('imgs/template/icons/icon-list-hover.svg') }}" alt="{{ __('List layout') }}">
                                </a>
                                <a class="view-type layout-company" href="#" data-layout="grid">
