...
<div class="form-group">
    <label class="control-label">{{ __('Highlight text in subtitle') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Button apply link') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Image left') }}</label>
    {!! Form::mediaImage('apply_image_left', Arr::get($attributes, 'apply_image_left')) !!}
</div>

<div class="form-group">
    <label class="control-label">{{ __('Image right') }}</label>
