...
<div class="form-group">
    <label class="control-label">{{ __('Load more text for first content') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Load more link for first content') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Image for first content') }}</label>
    {!! Form::mediaImage('image_of_first_content', Arr::get($attributes, 'image_of_first_content')) !!}
</div>

<div class="form-group">
    <label class="control-label">{{ __('Image alt text of first content') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Load more text for second content') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Load more link of second content') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Image of second content') }}</label>
    {!! Form::mediaImage('image_of_second_content', Arr::get($attributes, 'image_of_second_content')) !!}
</div>

<div class="form-group">
    <label class="control-label">{{ __('Image alt text of second content') }}</label>
