...
<div class="form-group">
    <label class="control-label">{{ __('Company address') }}</label>
...
<div class="form-group">
    <label class="control-label">{{ __('Company phone') }}</label>
...
@for ($i = 0; $i < 6; $i++)
    <div style="border: 1px solid #cac6c6; padding: 15px 10px; margin-bottom: 20px;">
        <div class="form-group">
            <label class="control-label">{{ __('Branch Company :number', ['number' => $i + 1]) }}</label>
        </div>
        <div class="form-group">
            <label class="control-label">{{ __('Branch Company Name') }}</label>
        ...
        <div class="form-group">
            <label class="control-label">{{ __('Branch Company Address') }}</label>
