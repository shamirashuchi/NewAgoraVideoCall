                                        ...
                                        <div class="text-info-right">
                                            ...
                                            <p class="font-xs">
                                                @if($category->active_jobs_count > 1)
                                                    {!! BaseHelper::clean(__(':number <span> Jobs Available </span>', ['number' => $category->active_jobs_count ])) !!}
                                                @elseif($category->active_jobs_count === 1)
                                                    {!! BaseHelper::clean(__(':number <span> Job Available </span>', ['number' => $category->active_jobs_count ])) !!}
                                                @else
