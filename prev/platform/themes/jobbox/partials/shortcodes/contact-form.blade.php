    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mb-40">
                ...
                @endif
                <form class="contact-form-style mt-30" action="{{ route('public.send.contact') }}" method="post">
                    @csrf
                    <div class="row wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="input-style mb-20">
                                <input @class(['font-sm color-text-paragraph-2', 'is-invalid' => $errors->has('email')]) name="email" placeholder="Your email" type="email" value="{{ old('email') }}">
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="textarea-style mb-30">
                                <textarea @class(['font-sm color-text-paragraph-2', 'is-invalid' => $errors->has('name')]) name="content" placeholder="{{ __('Tell us about yourself') }}">{{ old('content') }}</textarea>
                                @error('content')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
