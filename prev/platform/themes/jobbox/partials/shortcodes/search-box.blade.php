                                ...
                                @foreach($featureCompanies as $featureCompany)
                                    <div class="swiper-slide">
                                        <a href="{{ $featureCompany->url }}">
                                            <img src="{{ RvMedia::getImageUrl($featureCompany->logo_thumb) }}" alt="{{ $featureCompany->logo_thumb }}">
                                        </a>
                                    </div>
                                @endforeach
                            </div>
                                        ...
                                        <a href="{{ $category->url }}">
                                            <div class="item-logo">
                                                <div class="image-left">
                                                    <img alt="{{ $category->name }}" src="{{ RvMedia::getImageUrl($category->getMetadata('icon_image', true)) }}">
                                                </div>
