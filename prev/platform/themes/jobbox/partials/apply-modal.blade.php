            ...
            <div class="modal-content apply-job-form">
                ...
                <div class="modal-body pl-30 pr-30 pt-50">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            <button class="btn btn-default hover-up w-100" type="submit" name="login">{{ __('Apply Now') }}</button>
                        </div>
                    {!! Form::close() !!}
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content apply-job-form">
                ...
                <div class="modal-body pl-30 pr-30 pt-50">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="external-message">{{ __('Message') }}</label>
                        <textarea class="form-control" id="external-message" name="message" placeholder="{{ __('Enter your message') }}"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-default hover-up w-100" type="submit" name="login">{{ __('Send Application') }}</button>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
