<div class="form-group">
    ...
    @endif
    {!! Form::hidden('resume', $account->resume) !!}
...
@push('scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            @if ($account->resume)
                var file = ({name: '{{ File::name($account->resume) }}', size: '{{ Storage::exists($account->resume) ? Storage::size($account->resume) : 0 }}', 'url': '{{ $account->resume }}', 'full_url': '{{ RvMedia::url($account->resume) }}'});
