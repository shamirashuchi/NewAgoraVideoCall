...
@push('scripts')
    ...
    <form id="upload_form" action="{{ route('public.account.upload') }}" target="form_target" method="post" enctype="multipart/form-data" style="width:0;height:0;overflow:hidden;display: none;">
        @csrf
