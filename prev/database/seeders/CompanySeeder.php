...
class CompanySeeder extends BaseSeeder
{
    ...
    {
        Company::truncate();
        Slug::where('reference_type', Company::class)->delete();
        MetaBoxModel::where('reference_type', Company::class)->delete();
        LanguageMeta::where('reference_type', Company::class)->delete();
